...
## 规则
- [rules](rules.md) — 所有对话规则合集：底线/沟通/英语/弹窗/认知/标签

## 项目
- [user-profile](user-profile.md) — 用户画像：背景、能力、认知侧写、情绪模式、对话禁忌
- [coaching-strategy](coaching-strategy.md) — 引导策略：项目驱动、先想再补、三模切换
- [project-a-progress](project-a-progress.md) — 方案A工程量汇总器进度
- [novel-writer-project](novel-writer-project.md) — 小说写作工坊 v1.0，GitHub 开源
- [english-plan](english-plan.md) — 英语双线计划：日常词+场景句，技术词+语法纠正

## 经验库
- [experience-bank](experience-bank.md) — 经验库使用约定
